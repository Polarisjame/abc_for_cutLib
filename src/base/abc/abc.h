...
extern ABC_DLL void *             Abc_NodeGetCutsRecursiveMine( void * p, Abc_Obj_t * pObj, int fDag, int fTree );
...
extern ABC_DLL Abc_Ntk_t *        Abc_NtkDup_mine( Abc_Ntk_t * pNtk, int * fakeId2Id );
