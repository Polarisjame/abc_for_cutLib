...
//    fprintf( pFile, "module %s ( gclk,\n   ", Abc_NtkName(pNtk) );
    char file_path[4096];
    FILE * fp;
    if ( Abc_FrameMakeLogPath( file_path, sizeof(file_path), "abc_write_verilog.log" ) )
    {
