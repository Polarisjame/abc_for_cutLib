...
extern ABC_DLL char *          Abc_FrameReadLogDir();
extern ABC_DLL void            Abc_FrameSetLogDir( const char * pDir );
extern ABC_DLL int             Abc_FrameMakeLogPath( char * pBuffer, int nBufferSize, const char * pFileName );
extern ABC_DLL FILE *          Abc_FrameOpenLogFile( const char * pFileName, const char * pMode );
extern ABC_DLL int             Abc_FrameRedirectStdoutToLog( const char * pFileName, const char * pMode );
extern ABC_DLL int             Abc_FrameRestoreStdout();
