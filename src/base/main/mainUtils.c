...
void Abc_UtilsPrintUsage( Abc_Frame_t * pAbc, char * ProgName )
{
    fprintf( pAbc->Err, "\n" );
    fprintf( pAbc->Err,
             "usage: %s [-c cmd] [-q cmd] [-C cmd] [-Q cmd] [-f script] [-h] [-L dir] [-o file] [-s] [-t type] [-T type] [-x] [-b] [file]\n",
             ProgName);
    ...
    fprintf( pAbc->Err, "    -L dir\tset directory for debug log files created by instrumented code\n");
