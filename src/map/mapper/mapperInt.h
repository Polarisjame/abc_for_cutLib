...
struct Map_CutStruct_t_  
{
    ...
    unsigned            myTruthPos[2];    // truth table for positive phase cut: Pos[0]: lower 32-bit value, Pos[1]: higher 32-bit value
...
extern float             Map_MappingGetArea( Map_Man_t * pMan, int fDisplay);
/*=== mapperSwitch.c =============================================================*/
